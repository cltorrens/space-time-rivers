...
BIGC: https://www.neonscience.org/field-sites/bigc CARI: https://www.neonscience.org/field-sites/cari KING: https://www.neonscience.org/field-sites/king WALK: https://www.neonscience.org/field-sites/walk
...
# save df
path <- here("N_uptake_NEON/data/neon_data_by_year/king.df_2019.csv")
write_csv(king.df.2019, path)
...
# save df
path <- here("N_uptake_NEON/data/neon_data_by_year/king.df_2020.csv")
write_csv(king.df.2020, path)
...
walk.plot.2019 <- walk.df.2019 %>%
  ggplot(aes(x=local_datetime, y=surfWaterNitrateMean)) + 
  geom_point() + 
  labs(x="Date", y=expression("NO"[3]~"(umol/L)"), title= "Walker Creek TN nitrate: 2019") +
  theme_bw()
...
#### Not done - Walker Branch, TN 2019 tz = 'US/Eastern'

#### Not done - Walker Branch, TN 2022 tz = 'US/Eastern'
