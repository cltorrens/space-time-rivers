...
The data downloads by 1 site and 1 year - this for loop downloads 2021-23 with one command. Updated links download data up to the present (roughly - haven't checked 2025).
...
## Note that wd is set to: here("N_uptake_NEON/data/NSRDB_light_data_raw/5m"), BECAUSE for whatever reason, list.files() is searching the current directory and not the filepath :/
...
write_csv(bigc.satlight,file=here("N_uptake_NEON/data/NSRDB_data_clean/BIGC_satlight_all.csv"))
...
write_csv(blde.satlight,file=here("N_uptake_NEON/data/NSRDB_data_clean/BLDE_satlight_all.csv"))
...
write_csv(cupe.satlight,file=here("N_uptake_NEON/data/NSRDB_data_clean/CUPE_satlight_all.csv"))
