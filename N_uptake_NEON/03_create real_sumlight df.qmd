...
wlou.sat_light <- list.files(path="5m", pattern='WLOU', full.names = TRUE) %>%
...
write_csv(wlou.sat_light,file=here("N_uptake_NEON/data/NSRDB_data_clean/WLOU_satlight_all.csv"))
