...
45 minute intervals for sampling: 45 min = 1/32 of a day or 0.03125 d-1
...
wlou_light.df <- read_csv(here("N_uptake_NEON/data/NSRDB_data_clean/WLOU_satlight_all.csv")) %>%
...
# Note that the model_datetime tz is *also* set as Mountain
...
# For smaller NA chunks, (8 or fewer timesteps (<= 8 hours)?) , we will interpolate using zoo()
