...
UvGPP <- ggplot(data=U_GPP, aes(x=GPP.daily.mmol, y=U_mod_avg, color=season)) + 
  ...
  geom_abline(intercept= -4.25, slope = 1/10, linetype="dotted", color="grey") + #type 3
  geom_abline(intercept = -2.25, slope = 1/20, linetype = "dotdash", color="grey") + #type 2
  geom_abline(intercept = -1.5, slope = 1/30, linetype = "twodash", color="grey") + #type 4
  geom_abline(intercept=-1.25, slope = 1/40, linetype = "dashed", color='grey') + # type 6
  geom_abline(intercept=-1.1, slope = 1/50, linetype = "longdash", color='grey') + # type ?
