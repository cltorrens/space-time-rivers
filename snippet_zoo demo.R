# Snippets -> using %in% not == for filter, and zoo() demo code


#################  figuring out %in% vs ==  ______________________________________

no3_data_2123 <- no3_data_sensor %>%
  filter(year(startDateTime) %in% 2021:2023, 
         siteID == "WLOU")


#################  Demo code for zoo() ___________________________________________
